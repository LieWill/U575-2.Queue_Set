...
void MX_SPI1_Init(void)
{
  ...
  HAL_SPI_AutonomousMode_Cfg_Struct.TriggerSelection = SPI_GRP1_GPDMA_CH2_TCF_TRG;
  HAL_SPI_AutonomousMode_Cfg_Struct.TriggerPolarity = SPI_TRIG_POLARITY_FALLING;
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    */
    ...
    __HAL_LINKDMA(spiHandle, hdmatx, handle_GPDMA1_Channel12);
